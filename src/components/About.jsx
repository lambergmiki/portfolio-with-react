...
<p className="text-2xl text-center mb-10">As a second-year student, I've started doing more coding on the side. These are some of the technologies I've learned along the way, some more than others.</p>
