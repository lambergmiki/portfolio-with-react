  ...
  return (
    <section id="projects" className="px-6 py-10 text-xl">
      ...
      <p className="text-2xl mb-20 text-center">
        Click the title to access the project, or the card itself to see the
        next project.
      </p>
      ...
      <div ref={projectsWrapper} className="relative h-[400px] w-full">
        ...
        <div className="flex justify-between absolute project-cards bg-white h-40">
          ...
          <h3 className="description p-2 ml-20">
            My first large project with JavaScript. Possibly also my first
            "development request", as my wife requested this application. Want
            to see the live app? You can find it at{" "}
        ...
        <div className="flex justify-between absolute project-cards bg-white h-40">
          ...
          <h3 className="description p-2 opacity-0 ml-20">
            Solving one of the most non-important, important things: taking care
            of pizza dough. It was a great pleasure learning how hardware and
        ...
        <div className="flex justify-between absolute project-cards bg-white h-40">
          ...
          <h3 className="description p-2 opacity-0 ml-20">
            After manually reinstalling software and setting up configuration
            files on new/formatted laptops and desktops, I finally learned about
            backing up dotfiles and how a shell scripts can simplify your life.
          </h3>
        </div>
        ...
        <div className="flex justify-between absolute project-cards bg-white h-40">
          ...
          <h3 className="description p-2 opacity-0 ml-20 text-balance">
            My very first hands-on experience programming happened to be in
            Python. I highly recommend
            <a
            ...
            to those curious about programming with little to no experience
            beforehand. The project is untouched since then, just so I can see
